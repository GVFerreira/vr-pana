...
<html lang="pt-br">
    <head>
        <meta charset="UTF-8">
    <title>Validação - Desafio Panasonic V-Razor</title>
    ...
    <a-scene>
            ...
            <a-entity 
                geometry="primitive: plane; width: 2; height: 0.5; depth: 0.1" 
                material="color: #FFFFFF" 
                position="0 -1 -5"
                cursor-listener
                onclick="navigateToPage('regras')"
    ...
    <script>
        ...
        // Evento de popstate para manipular as mudanças de histórico
