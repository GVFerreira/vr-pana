            ...
            <section class="container_r">
                ...
                <form class="form_register" action="cadastro-lp.php" method="post">
                    ...
                    <div class="input_group_tel">
                        ...
                        <input type="text" class="input_style" id="celular" name="celular" placeholder="Celular" inputmode="numeric" title="Preencha com um celular válido" maxlength="11" required>
                    </div>
